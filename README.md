...
2. Pull Llama 3.2 Model via Ollama
...
git clone [https://github.com/Musamnsaeed/AI_SOC.git](https://github.com/Musamnsaeed/AI_SOC.git)
cd AI_SOC

# Create virtual environmendocker-compose up --build -dt
...
Option A: Run Log Triage Pipeline
To process sample logs and run AI triage manually:

Bash
python src/soc_pipeline_v2.py
Option B: Launch Streamlit SOC Dashboard
Bash
streamlit run app.py
Open your browser at http://localhost:8501 to view the dashboard! 🚀

🔑 Environment Variables Setup (Optional CTI Keys)
For live IP lookup on AbuseIPDB & VirusTotal, create a .env file in the root folder:

Code snippet
ABUSEIPDB_API_KEY="your_abuseipdb_api_key"
VIRUSTOTAL_API_KEY="your_virustotal_api_key"
🛠️ Features
Hybrid Processing Pipeline: Fast-path rule filtering paired with deep-pass local LLM triage.
